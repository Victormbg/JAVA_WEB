...
<jsp:useBean id="cont" 
	...
	<c:forEach items="${cont.listarCategoria() }"
		...
		<tr>
		    ...
		    <td><a href="../categoria?id=${_cat.id}&acao=buscar">Alterar</a> /
		    <a href="categoria?id=${_cat.id }&acao=excluir">Excluir</a>
		    </td>
		</tr>
	</c:forEach>			
	</table>			
	</jsp:useBean>
	<a href="categoria?acao=inicioInclusao">Incluir Categoria</a>
</body>
</html>